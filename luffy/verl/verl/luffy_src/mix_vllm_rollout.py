    ...
    def generate_sequences(self, prompts: DataProto, max_retries: int = 1e9, **kwargs) -> DataProto:
        ...
        for attempt in range(max_retries):
            try:
                ...
                tgt_input_ids = None
                if 'hint_input_ids_0' in prompts.batch: # in train mode
                    tgt_input_ids = prompts.batch['hint_input_ids_0']  # [bsz, tgt_len]
                ...
                if 'hint_input_ids_0' in prompts.batch:
                ...
                if tgt_input_ids is not None:
                    batch['hint_input_ids_0'] = tgt_input_ids
