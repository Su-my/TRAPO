...
class MIXRayPPOTrainer(RayPPOTrainer):
    ...
    def __init__(self,
        ...
        assert self.use_reference_policy, f"MIXRayPPOTrainer currently only supports using reference policy."
    ...
    def _create_dataloader(self):
        ...
        if self.config.data.shuffle:
            from verl.luffy_src.rl_dataset_with_target import ResumableRandomSampler
        ...
        assert len(self.train_dataloader) >= 1, f"Size of train dataset: {len(self.train_dataset)}"
    ...
    def fit(self):
        ...
        for _ in range(self.config.trainer.total_epochs):
            ...
            for batch_dict in self.train_dataloader:
                ...
                gen_batch = batch.pop(batch_keys=['input_ids', 'attention_mask', 'position_ids', 'hint_input_ids_0'])
                ...
                with _timer('step', timing_raw):
                    ...
                    with _timer('adv', timing_raw):
                        ...
                        assert "ref_log_prob" in batch.batch.keys(), f"ref_log_prob not in batch while use_reference_policy is True"
