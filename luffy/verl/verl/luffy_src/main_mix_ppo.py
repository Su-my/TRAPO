...
from verl.luffy_src.reward_with_format import deepscaler_reward_fn_impl1
from verl.luffy_src.math_verify_reward import reward_fn_math_verify, reward_fn_math_verify_no_think
...
class RewardManager():
    ...
    def __call__(self, data: DataProto):
        ...
        def process_item(args):
            ...
            if "prefix_mask" in data_item.batch:
                prefix_length = data_item.batch["prefix_mask"].sum()
                prefix_response_ids = response_ids[:prefix_length]
                suffix_response_ids = response_ids[prefix_length:valid_response_length]
                prefix_response_str = self.tokenizer.decode(prefix_response_ids, skip_special_tokens=False)
                suffix_response_str = self.tokenizer.decode(suffix_response_ids, skip_special_tokens=False)
            else:
                prefix_response_str = None
                suffix_response_str = None
            ...
            score = compute_score_fn(prompt_str=prompt_str, solution_str=sequences_str, ground_truth=ground_truth, prefix_response_str=prefix_response_str, suffix_response_str=suffix_response_str)
    ...
    if not ray.is_initialized():
        ...
        ray.init(
            ...
            runtime_env={'env_vars': {
                ...
                "WANDB_API_KEY": "f965322c0067b96675ac29ec31ccc0ea4ce3d0dc",
            }}
        )
