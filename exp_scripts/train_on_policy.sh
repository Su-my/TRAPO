...
export EXP_NAME=verl-add5-aime25-original-GRPO-luffy
...
export TMPDIR=/data1/sumingyu/temp

export TORCHINDUCTOR_CACHE_DIR=/data1/sumingyu/temp
export TRITON_CACHE_DIR=/data1/sumingyu/temp

export CUDA_CACHE_PATH=/data1/sumingyu/temp

export HF_DATASETS_CACHE=/data1/sumingyu/temp
export TRANSFORMERS_CACHE=/data1/sumingyu/temp


cd /home/sumingyu/TRAPO/luffy/verl
# export PYTHONPATH=/home/sumingyu/LUFFY/TRAPO/verl:$PYTHONPATH

# Train over a single node, 8 A100-80GB GPUs.
python3 -m verl.luffy_src.main_mix_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=/home/sumingyu/TRAPO/data/merged_selected.parquet \
    data.val_files=/home/sumingyu/TRAPO/data/valid.all.parquet \
